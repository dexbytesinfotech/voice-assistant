...
class _BottomSheetViewState extends State<BottomSheetView> {
  ...
  Widget topErrorMessageView(){
    return Column(children: [
      Text(topErrorMessage,style: const TextStyle(
          color: Colors.black, fontWeight: FontWeight.bold,fontSize: 15)),const SizedBox(height: 5,),
      Text(topSecondMessage,style: const TextStyle(
          color: Colors.black54, fontWeight: FontWeight.normal))
    ],);
  }
  Widget bottomErrorMessageView(){
    return Column(children: [
      Text(bottomMessage,style: const TextStyle(
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    isError?const SizedBox(height: 0,):topMessageView(),
                    ...
                    !isError?(textStringValue.isEmpty && !isListen?bottomErrorMessageView():const SizedBox(height: 0,)):bottomErrorMessageView()
                  ],
                ),
              ],
            ),
